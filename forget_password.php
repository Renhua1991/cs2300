  	...
  	if(isset($_POST['forget_pass'])){
		...
		if($count == 1){
			...
			if ($rows['user_name'] == $_POST['check_username'] ) {
				...
				$new_query = "UPDATE user SET password = '$new_pass' WHERE email = '$to'";
			...
			// } 
				...
				echo "<p style=text-align:center>username and email don't match.</p>";
			}

		}
		else{
				echo "<p style=text-align:center>Can't find information for this account</p>";
		}
